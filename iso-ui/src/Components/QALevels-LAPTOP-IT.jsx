...
const QALevels = () => {
    ...
    useEffect(() => {
        fetch(`${BASER_URL}/documents?filters[department][$eq]=QA&populate=*`)
                                    ...
                                    <div className="row">
                                        <div className="col-8">
                                            <div className="numbers">
                                                <h5 className="font-weight-bolder">QA Level 1</h5>
                            ...
                            <div className="card">
                                <div className="card-body p-3">
                                    <div className="row">
                                        <div className="col-8">
                                            <div className="numbers">
                                                <h5 className="font-weight-bolder">QA Level 2</h5>
                            ...
                            <div className="card">
                                <div className="card-body p-3">
                                    <div className="row">
                                        <div className="col-8">
                                            <div className="numbers">
                                                <h5 className="font-weight-bolder">QA Level 3</h5>
                            ...
                            <div className="card">
                                <div className="card-body p-3">
                                    <div className="row">
                                        <div className="col-8">
                                            <div className="numbers">
                                                <h5 className="font-weight-bolder">QA Level 4</h5>
                    ...
                    <div className="col-12">
                        <div className="card mb-4">
                            <div className="card-header pb-0">
                                <h6>All files from the QA directory</h6>
                            </div>
